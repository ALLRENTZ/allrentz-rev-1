...
FROM public.submit_vendor_quote(
  ...
  '{"schema_version":1,"currency_code":"USD","calculation_policy_version":"allrentz-usd-1","tax_status":"not_calculated","tax_exemption_claimed":false,"vendor_stated_total":"2250.00","rate_terms":[{"line_key":"equipment_rental","rate_basis":"per_day","rate_scope":"per_equipment_item","equipment_quantity":"1","rental_period_quantity":"7","period_quantity_source":"vendor_stated","proration_policy":"unknown","rental_period_definition":"Seven consecutive 24-hour periods","vendor_calculation_terms":"Vendor-stated seven-day extension","unit_rate":"300.0000","amount_status":"priced","calculation_method":"vendor_stated","line_amount":"2100.00"}],"charge_lines":[{"line_key":"delivery","charge_type":"delivery","description":"Delivery fee","amount_status":"priced","calculation_method":"fixed","amount":"100.00"},{"line_key":"pickup","charge_type":"pickup","description":"Pickup fee","amount_status":"not_applicable","calculation_method":"incomplete"},{"line_key":"environmental","charge_type":"environmental","description":"Environmental fee","amount_status":"not_applicable","calculation_method":"incomplete"},{"line_key":"mobilization","charge_type":"mobilization","description":"Mobilization fee","amount_status":"priced","calculation_method":"fixed","amount":"50.00"}]}'::jsonb,
  current_date + 1,
  false,
  NULL,
  true,
