# ALLRENTZ Enterprise Infrastructure as Code
# AWS ECS Fargate deployment with Blue-Green deployment strategy
...
terraform {
  ...
  backend "s3" {
    bucket         = "allrentz-terraform-state"
    key            = "production/terraform.tfstate"
    region         = "us-east-1"
    encrypt        = true
    dynamodb_table = "allrentz-terraform-locks"
  }
}
