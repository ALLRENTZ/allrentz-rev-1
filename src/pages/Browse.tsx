...
import { Search, MapPin, Star, CheckCircle, Calendar, DollarSign, Map, Shield } from 'lucide-react';
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select";
import { Input } from "@/components/ui/input";
import { Button } from "@/components/ui/button";
import EquipmentVerificationSystem, { getEquipmentVerificationStatus } from '@/components/EquipmentVerificationSystem';
        ...
        <div className="p-6">
          ...
          <div className="mb-4">
            <EquipmentVerificationSystem 
              ...
              onRequestPhotos={() => handleRequestPhotos(item.name)}
              onRequestSpecs={() => handleRequestSpecs(item.name)}
